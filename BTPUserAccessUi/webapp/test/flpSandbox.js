		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "BMI User Access Request Approval",
									"targetURL": "#comsapbmiBTPUserAccessUi-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapbmiBTPUserAccessUi-display": {
								"semanticObject": "comsapbmiBTPUserAccessUi",
								"action": "display",
								"description": "BMI User Access Request Approval",
								"title": "BMI User Access Request Approval",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.bmi.BTPUserAccessUi",
									"url": sap.ui.require.toUrl("com/sap/bmi/BTPUserAccessUi")
								}
							}
						}
					}
